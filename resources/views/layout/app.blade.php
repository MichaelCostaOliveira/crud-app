...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    @include('layout.nav_topo')
    @include('layout.nav_lateral')
    @include('layout.pagina')
    ...
    <script src="{{ asset('app-assets/js/scripts/pages/datatble_portugues.js') }}"></script>
    @stack('js_vendor')
